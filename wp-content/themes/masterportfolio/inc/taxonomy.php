...
function masterportfolio_custom_taxonomy() {

    $labels = array(
        'name' => _x('Categories', 'Taxonomy General Name', 'masterportfolio'),
        'singular_name' => _x('Category', 'Taxonomy Singular Name', 'masterportfolio'),
...
add_action('init', 'masterportfolio_custom_taxonomy', 0);
